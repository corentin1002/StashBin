...
return [
    ...
    'create.logged_in'           => 'Connecté en tant que {user} — {secrets} — {logout}',
    ...
    'create.title_label'         => 'Titre (optionnel)',
    'create.title_placeholder'   => 'Pour le retrouver dans votre liste',
    'create.title_notice'        => 'Le titre n\'est pas chiffré : contrairement au secret, le serveur peut le lire.',
    ...
    'secrets.intro'           => 'Ce que vous avez créé, et ce qu\'il en est advenu. Les secrets ne sont pas consultables depuis cette page : leur clé n\'a jamais quitté votre navigateur.',
    'secrets.back'            => 'créer un secret',
    'secrets.empty'           => 'Vous n\'avez encore créé aucun secret.',
    'secrets.untitled'        => 'Sans titre',
    'secrets.identifier'      => 'Identifiant',
    'secrets.created'         => 'Créé le {date}',
    'secrets.expires'         => 'Expire le {date}',
    ...
    'secrets.gone_on'         => 'Disparu le {date}',
    ...
    'error.title_too_long'     => 'titre trop long',
