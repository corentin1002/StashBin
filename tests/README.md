...
| `browser.test.mjs` | 52 | Real Chromium: end-to-end cryptography, complete interface journeys, the creator's inventory as they see it, an expiry picked by hand, the interface served in the browser's language, and the layout on a phone-sized screen |
